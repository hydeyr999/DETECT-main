...
for domain in ${domains[@]}; do
  ...
  --classifier ./detectors/ling-based/classifier/cross-domain/gltr_$domain\_n${n_sample}.pkl --multilen $multilen \
...
for operation in ${operations[@]}; do
  ...
  --classifier ./detectors/ling-based/classifier/cross-operation/gltr_$operation\_n${n_sample}.pkl --multilen $multilen \
  --n_sample $n_sample --device $device --mode test --func $func
done